...
core/ and clean/, composing the two. Keeping them out of the feature modules is
what lets ui.navigator stay a toolkit that knows nothing about applications or
cleanup -- tach enforces that: src.ui may depend only on src.core, while
src.ui.screens may reach for the feature packages.
